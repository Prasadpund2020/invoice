...
export default function OnboardingPage() {
  ...
  return (
    <div className="flex items-center justify-center flex-col min-h-dvh h-dvh overflow-hidden relative p-4">
      {/* ✅ Changed overflow-auto to overflow-hidden above to avoid scrollbar layout bugs */}

      {/* ✅ Wrapped both background layers in one parent with overflow-hidden */}
              ...
              >
                ...
                <SelectContent>
                  {Object.keys(currencyOption).map((item: string) => (
                    <SelectItem className="side-bottom" key={item} value={item}>
                      {item}
                    </SelectItem>
                  ))}
                </SelectContent>
